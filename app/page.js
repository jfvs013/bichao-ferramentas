...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-[#121212] text-white transition-colors duration-500">
      ...
      <section
        className="relative w-full h-[500px] mb-12 bg-cover bg-center bg-no-repeat"
        style={{ backgroundImage: "url('/images/logoBichaoFerramentasBG.png')" }}
      >
      ...
      <section className="container mx-auto px-4 mb-16">
        <div className="py-12 bg-[#F5F5F5] text-[#121212] transition-colors duration-500 rounded-lg shadow-lg">
      ...
      <section className="container mx-auto px-4 mb-16">
        <div className="bg-[#2C2C2C] rounded-lg shadow-lg py-12 px-8">
      ...
      {/* Seção de Destaques */}
      <section className="container mx-auto px-4 mb-16">
        <div className="bg-[#121212] rounded-lg shadow-lg py-12 px-8 transition-colors duration-500 text-white">
