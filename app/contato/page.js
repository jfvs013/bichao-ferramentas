...
export default function ContatoPage() {
  ...
  const contactInfo = [
    ...
    },
    {
      ...
      title: "Endereço",
      content: "Rua das Ferramentas, 123",
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            <div className="space-y-8">
                ...
                <div className="space-y-4">
                  {departments.map((dept, index) => (
                    <div key={index} className="border-b border-gray-200 pb-4 last:border-b-0 last:pb-0">
                      <h4 className="font-semibold text-primary-black mb-2">{dept.name}</h4>
                      <div className="space-y-1 text-sm text-primary-graphite">
                        <div className="flex items-center">
                          <svg className="w-4 h-4 mr-2 text-secondary-orange" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                          </svg>
                          <a href={`mailto:${dept.email}`} className="hover:text-secondary-orange transition-colors">
                            {dept.email}
                          </a>
                        </div>
                        <div className="flex items-center">
                          ...
                          <a href={`tel:${dept.phone}`} className="hover:text-secondary-orange transition-colors">
                            {dept.phone}
                          </a>
                        </div>
                      </div>
              ...
              <div className="bg-accent-green rounded-lg shadow-md p-8 text-primary-white">
                ...
                <WhatsAppButton 
                  position="inline"
                  className="bg-primary-white text-accent-green hover:bg-gray-100"
                />
              </div>
              ...
              <div className="bg-primary-white rounded-lg shadow-md p-8">
                <h3 className="text-xl font-bold text-primary-black mb-4">
                  Nossa <span className="text-secondary-orange">Localização</span>
                </h3>
                <div className="aspect-video bg-gray-200 rounded-lg flex items-center justify-center">
                  <div className="text-center text-primary-graphite">
                    <svg className="w-12 h-12 mx-auto mb-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z" />
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15 11a3 3 0 11-6 0 3 3 0 016 0z" />
                    </svg>
                    <p>Mapa interativo será carregado aqui</p>
                    <p className="text-sm mt-1">Rua das Ferramentas, 123 - São Paulo/SP</p>
                  </div>
                </div>
              </div>
            </div>
