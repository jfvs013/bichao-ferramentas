      ...
      <section className="pb-16">
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            {/* WhatsApp */}
            <div className="bg-accent-green rounded-lg shadow-md p-8 text-primary-white flex flex-col justify-center items-center text-center">
              ...
              <h3 className="text-2xl font-bold mb-2">Atendimento via WhatsApp</h3>
