...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-[#121212] text-white transition-colors duration-500">
      ...
      <section className="container mx-auto px-4 mb-16 py-12 bg-[#F5F5F5] text-[#121212] transition-colors duration-500 rounded-lg shadow-lg">
      ...
      {/* Seção de Destaques */}
      <section className="bg-[#121212] py-16 mb-16 transition-colors duration-500 text-white">
